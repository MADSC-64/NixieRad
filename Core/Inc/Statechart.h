...
#define SCVI_STATECHART_S_FAST_MEASUREMENT____ 0
#define SCVI_STATECHART_S_SLOW_MEASUREMENT____ 0
#define SCVI_STATECHART_S_MSV_RATE 0
#define SCVI_STATECHART_S_THRESHOLD 0
...
typedef enum  {
	...
	Statechart_BeSlow,
	Statechart_BeFast,
	Statechart_setmsVRate,
	Statechart_setThreshold
} StatechartEventID;
...
typedef enum
{
	...
	Statechart_s_Fast_Measurement____,
	Statechart_s_Slow_Measurement____,
	Statechart_s_msV_Rate,
	Statechart_s_Threshold
} StatechartStates;
...
{
	sc_boolean BeSlow_raised;
	sc_boolean BeFast_raised;
	sc_boolean setmsVRate_raised;
	sc_boolean setThreshold_raised;
};
...
/*! Raises the in event 'BeSlow' that is defined in the default interface scope. */ 
extern void statechart_raise_beSlow(Statechart* handle);
/*! Raises the in event 'BeFast' that is defined in the default interface scope. */ 
extern void statechart_raise_beFast(Statechart* handle);
/*! Raises the in event 'setmsVRate' that is defined in the default interface scope. */ 
extern void statechart_raise_setmsVRate(Statechart* handle);
/*! Raises the in event 'setThreshold' that is defined in the default interface scope. */ 
extern void statechart_raise_setThreshold(Statechart* handle);
